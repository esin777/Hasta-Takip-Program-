...
namespace Hasta_Takip_Programı.Forms
{
    public partial class FrmAppointment : Form
    {
        ...
        void GetAppointmentList()
        {
                ...
                {
                    dgAppointment.Rows.Add(appointment.Id, appointment.AppointmentDate, appointment.AppointmentTime, appointment.PatientId, appointment.DoctorId, appointment.ReasonForVisit, appointment);
                }
            }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if ( txtAppointmentTime.Text == "" || txtPatientId.Text == "" || txtReasonForVisit.Text == "" || txtAppointmentDate.Text == "" || txtDoctorId.Text == "" )
            {
            ...
            appointment.DoctorId = Convert.ToInt32(txtId.Text);
            appointment.PatientId = Convert.ToInt32(txtPatientId.Text);
            DateTime dateTime = Convert.ToDateTime(txtAppointmentTime.Text);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (txtAppointmentDate.Text == "" || txtAppointmentTime.Text == "" || txtReasonForVisit.Text == "" || txtPatientId.Text == "" || txtDoctorId.Text == "")
            {
                MessageBox.Show("Lütfen Tüm Alanları Doldurunuz!", "Hata", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }

            if (db.Appointments.Count(c => c.Id == Convert.ToInt32(txtId.Text)) > 0)
            {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            var appointment = Convert.ToInt32(txtId.Text);
